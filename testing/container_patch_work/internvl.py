...
class InternVLChatModel(nn.Module):
    ...
    def get_mm_data(self, prompt, embeddings, **kwargs):
        ...
        image_offsets = self.get_mm_items_offset(
            input_ids=input_ids_tensor.to(embeddings[Modality.IMAGE].device),
