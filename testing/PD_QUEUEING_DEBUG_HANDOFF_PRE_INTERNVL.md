...
This file contains the pre-InternVL PD queueing and native SGLang E/PD search
history. InternVL-focused work was split out to
`PD_QUEUEING_DEBUG_HANDOFF_INTERNVL.md` to keep future Codex sessions under the
context window.
